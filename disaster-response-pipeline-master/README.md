...
In this project, I'll apply data engineering to analyze disaster data to build a model for an API that classifies disaster messages.
...
![master](image/home.jpg)

What the app will do is that it will classify the text message into categories so that appropriate relief agency can be reached out for help.

**_Screenshot 2_**

![results](image/response.jpg)
...
![process_data](image/process_data.jpg)
...
![train_classifier_1](image/train_classifier_1.jpg)
...
![train_classifier_2.jpg](image/train_classifier_2.jpg)
